...
function t_guide() {
	add_theme_page('Руководство пользователя', 'Руководство пользователя', 8, 'user_guide', 't_guide_options');
...
<div class="gblock">
  ...
  <h2>Как добавить миниатюры к постам?</h2>
	...
	<h2> Как создать пост со списком недвижимости </h2>
	<p><iframe src="http://www.screenr.com/embed/2IRs" width="650" height="396" frameborder="0"></iframe></p>
	
	<h2> Настройки шаблона Avenue. </h2>
	<p><iframe src="http://www.screenr.com/embed/QIRs" width="650" height="396" frameborder="0"></iframe></p>
